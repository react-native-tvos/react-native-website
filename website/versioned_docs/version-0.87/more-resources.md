...
Looking for something hands on? The [RNTPTest example app](https://github.com/react-native-tvos/RNTPTest) and the [Expo TV examples](https://github.com/expo/examples) show working Apple TV and Android TV projects. You can look at their source code—try running one on a TV simulator or device.
