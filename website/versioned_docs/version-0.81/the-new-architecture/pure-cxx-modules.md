...
{`curl -O https://raw.githubusercontent.com/react-native-tvos/react-native-tvos/${getTvBranchNameForCurrentVersion()}/packages/react-native/ReactAndroid/cmake-utils/default-app-setup/OnLoad.cpp`}
</CodeBlock>
